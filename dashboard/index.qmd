...
<div class="methodik">
  <style>
    ...
    .methodik-hero { border-bottom: 1px solid var(--line); padding-bottom: 18px; }
    .methodik-eyebrow {
    ...
    .methodik-hero h2 { font-size: 1.6rem; line-height: 1.25; margin: 6px 0 8px; }
    .methodik-lede { color: var(--muted); max-width: 62ch; margin: 0; }
  ...
  <div class="methodik-hero">
    <div class="methodik-eyebrow">Methodik</div>
  ...
  <div class="methodik-section methodik-split">
    <div>
      ...
      <p style="margin:0">
        ...
        Über den Institutsfilter in der Seitenleiste lässt sich statt der gepoolten
        Schätzung ein einzelnes Institut betrachten.
      </p>
      <ul class="methodik-institutes">
        ${methodik_institutes.map(i => html`
          <li><span>${i.name}</span><span>zuletzt ${i.date}</span></li>
        `)}
      </ul>
    </div>
    <div>
      ...
      <p style="margin:0">
        ...
        Wahlausgängen hätte das Bündnis eine Mehrheit — wenn heute gewählt würde und
        die Umfragen den Trend richtig treffen. Über das politische Zustandekommen
        einer Koalition sagt das nichts.
      </p>
  ...
  <div class="methodik-refs">
    Bender, A. &amp; Bauer, A. (2018). coalitions: Coalition Probabilities in
    Multi-Party Democracies. <i>Journal of Open Source Software</i>, 3(23), 606.
    · Quellcode:
    <a href="https://github.com/adibender/koala" target="_blank">github.com/adibender/koala</a>
  </div>
</div>
`
```
