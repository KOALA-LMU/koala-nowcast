...
plotCoalitionDensity = (group, height = 260, probability) => {
  ...
  const probMajority = densityValue(probability)
  ...
  const probabilityLabel = !Number.isFinite(probMajority)
    ? "keine Angabe"
    : probMajority < 0.001
      ? "<0,1%"
...
//| label: chart-coalition-densities
{
  ...
  const historyProbabilityByLabel = latestCoalitionProbabilityByLabel(coal_history_source)
  ...
  const draw = () => {
    ...
    const probability = historyProbabilityByLabel.get(group?.label)
    plotArea.replaceChildren(
      group
        ? plotCoalitionDensity(group, 380, probability)
...
<div class="projekt">
  ...
  <div class="projekt-hero">
    ...
    <p class="projekt-lede">
      ...
      Berechnungen basieren auf dem R-Paket
      <a href="https://github.com/adibender/coalitions" target="_blank"><code>coalitions</code></a>
      (Bender &amp; Bauer, 2018). Nähere Informationen zur statistischen Methodik
      sind zu finden unter
      <a href="https://doi.org/10.21105/joss.00606" target="_blank">doi.org/10.21105/joss.00606</a>.
    </p>
  </div>
</div>
`
