...
Besonders deutlich zeigt sich die verbleibende Unsicherheit an der Fünfprozenthürde. Die CDU lag in der gepoolten KOALA-Schätzung bei 7,0 Prozent. In allen 10.000 Simulationen erreichte sie mindestens fünf Prozent; im vorläufigen Ergebnis blieb sie mit 4,9 Prozent dennoch knapp unter der Hürde und erhielt keine Sitze. Ein simulierter Wert von 100,0 Prozent bedeutet nicht, dass ein anderes Ergebnis grundsätzlich unmöglich war, sondern nur, dass es unter den Modellannahmen in den gezogenen Simulationen nicht auftrat.
